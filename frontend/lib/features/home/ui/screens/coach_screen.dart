                  ...
                  Padding(
                    ...
                    child: coachAsync.when(
                      data: (coach) => isDiabetic 
                          ...
                          : _FitnessCoachContent(coach: coach, user: user, weight: weight),
...
class _DiabeticCoachContent extends StatelessWidget {
...
class _FitnessCoachContent extends StatelessWidget {
  final CoachState coach;
  final UserProfile user;
  final WeightState weight;

  const _FitnessCoachContent({required this.coach, required this.user, required this.weight});
        ...
        AppCard(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              WeightJourneyCard(start: user.startingWeight, now: weight.currentWeight, goal: user.weightGoal),
            ],
          ),
        ),
